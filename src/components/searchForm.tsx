  ...
  return (
    <div className="w-full h-screen bg-gradient-to-b from-slate-600 to-slate-900">
      <div className="w-full h-full flex flex-col sm:justify-center items-center pt-[224px] sm:pt-0">
        ...
        >
          <div
            className={`relative w-[270px] sm:w-[480px] md:w-full flex justify-center items-center
            md:mr-8
           `}
          >
            <input
          ...
          <button
            ...
            ${
              isButtonDisabled
                ? "text-white bg-slate-900 opacity-20 grayscale"
                : isConverting
                ? "md:w-56 text-indigo-600 bg-slate-300 transition-all duration-300 ease-in-out"
                : "text-white bg-indigo-600 hover:text-indigo-600 hover:bg-slate-300"
            }
          ...
          >
            {isConverting ? (
              <div className="relative w-6 h-6 mr-3 animate-spin rounded-full bg-gradient-to-r from-indigo-600  to-slate-300 ">
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-4 h-4 bg-slate-300 rounded-full border-2 border-slate-300"></div>
              </div>
            ) : // <svg
            //   aria-hidden="true"
            //   role="status"
